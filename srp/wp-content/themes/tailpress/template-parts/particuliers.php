<?php
/*
 * Template Name: Page particuliers
...
get_header(); ?>
    ...
    <div class="flex justify-center items-center py-20 px-10 sm:flex-col mx-auto-120px mx-auto-80px mx-auto-40px mx-auto-20px">
        ...
        <div class="flex flex-col justify-center items-center">
            ...
            <h2 class="text-greywhite text-style-desktop-title-h-2-35-px mt-5 text-center"><?php echo('SRP Détective est présent '); ?><br><?php echo('pour tout particulier '); ?> </h2>
